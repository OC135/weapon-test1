...
"rotation":[0,0,0]
    ...
    geofs.aircraft.instance.addParts([{
"name":"pfd9",
"model": "https://OC135.github.io/test6/pf2a1.glb",
"position": [0,0,0],
"rotation":[0,0,0]
}]
);
...
<br>
 <label><input type="radio" name="option" value="option1"  data-value="1">F-15E pylon</label><br>
  ...
  <label><input type="radio" name="option" value="option3"  data-value="3">FA-18F pylon</label><br>
  <label><input type="radio" name="option" value="option4"  data-value="4">A-10C pylon</label><br>
